...
const Footer = () => (
    <footer className="main-footer">
        <p>
            Inhalte lizenziert unter <a href="LICENSE-CC-BY-NC-ND.md" target="_blank" rel="noopener noreferrer">CC BY-NC-ND 4.0</a>.
            Für kommerzielle Nutzung siehe <a href="license-commercial.md" target="_blank" rel="noopener noreferrer">Lizenzdetails</a>.
        ...
        <main>
          ...
          <section id="beweise" aria-labelledby="evidence-heading">
            ...
            <div className="evidence-grid">
              <div className="evidence-card">
                <h3>🔧 Werkzeuge, die ich gebaut habe:</h3>
                <ul>
                  <li>Minder Web</li>
                  <li>VibeCheck</li>
                </ul>
              ...
              <div className="evidence-card">
                <h3>🌍 Welten, die ich erschaffen habe:</h3>
                <ul>
                  <li>AGKE</li>
              ...
              <div className="evidence-card">
                <h3>📡 Protokoll, das ich entworfen habe:</h3>
                <ul>
                  <li>GCP</li>
                </ul>
              </div>
          ...
          <section id="kontakt" className="cta-section" aria-labelledby="cta-heading">
            ...
            <div className="cta-buttons">
              ...
              <a href="https://tekkdax.github.io/von-gedanken-zu-welten/" target="_blank" rel="noopener noreferrer" className="btn btn-secondary">
                <span>🌐 Homepage</span>
              </a>
            </div>
          </section>
