...
const Footer = () => (
    <footer className="main-footer">
        <p>
            Inhalte lizenziert unter <a href="https://github.com/tekkDAX/DEIN_REPO_NAME/blob/main/LICENSE-CC-BY-NC-ND.md" target="_blank" rel="noopener noreferrer" aria-label="Creative Commons Lizenz">CC BY-NC-ND 4.0</a>.
            Für kommerzielle Nutzung siehe <a href="https://github.com/tekkDAX/DEIN_REPO_NAME/blob/main/license-commercial.md" target="_blank" rel="noopener noreferrer" aria-label="Kommerzielle Lizenz">Lizenzdetails</a>.
